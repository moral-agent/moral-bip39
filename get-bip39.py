...
#----------------------------------------------------
# Convert the hex output of SHA256 to BIP39 word list
#----------------------------------------------------

def print_bip39(entropy):
...
#----------------------------------------------------
# Convert the hex output of SHA256 to a password
#----------------------------------------------------

def print_password(entropy):
    #--------------------------
...
# The 000 is an index to get lots of seed phrases from the same entropy
# S prefix to create BIP39 seed phrase
# P prefix to create password
# Reason for prefix is to not accidentally create a password that also secures funds

preimg = 'S' + '000' + entropy_a + entropy_b
# preimg = 'P' + '000' + entropy_a + entropy_b

entropy = H(preimg)

if entropy == "AFEA4045A04E111BE94C7A9687EBFCEC61AD5DD8B7A08A5E5B826C34F4E81048":
...
if preimg.startswith('S'):
    print_bip39(entropy)
elif preimg.startswith('P'):
    print_password(entropy)
